...
const (
	Bits512  RSABits = 512
	Bits1024 RSABits = 1024
	Bits2048 RSABits = 2048
	Bits4096 RSABits = 4096
)

// GenerateKeyPair generates a new key pair
func GenerateKeyPair(bits RSABits) (*rsa.PrivateKey, *rsa.PublicKey, error) {
...
func Sign(msg []byte, priv *rsa.PrivateKey) ([]byte, error) {
	...
	ciphertext, err := rsa.SignPKCS1v15(rand.Reader, priv, crypto.SHA256, hashed[:])
	if err != nil {
		return nil, err
	}
	return ciphertext, nil
